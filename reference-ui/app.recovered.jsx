...
import {
 ...
 Home, Folder, Activity, MessageCircle, Stethoscope,

 Search, Plus, FileText, Pill, FileStack,

 Send, CheckCircle2, Loader2, Microscope,

 ScanFace, ChevronRight, Droplets, HeartPulse,

 AlertCircle, CalendarPlus, ShoppingBag, ChevronLeft
...
const Sparkline = ({ points, endColor }) => (
...
export default function App() {
 ...
 const renderSection = (title, data, iconColorClass) => {
